  ...
  return (
    <article className="article container">
      ...
      <figure className="hero">
        <img src="/assets/aa3.JPG" alt="דמות ראשית" />
        <figcaption>צילום שסופק על ידי העורכים</figcaption>
      </figure>

      <div className="article-body">
        <p>הוא לא מיליונר יהלומים, לא טס בפרייבט ג’ט, ובטח שלא חבר של דן בילזריאן, אבל האשכנזי הגבוה עם העיניים הכחולות ממיאמי הפך בחודשים האחרונים לאגדה אורבנית בתל אביב.</p>
        ...
        <div className="inline-image">
          <img src="/assets/aa2.jpg" alt="תמונה נוספת" />
      ...
      <footer className="article-footer">
        <div className="tags">
          ...
          <a href="https://timeout.co.il/">#מחאה</a>
          <a href="https://timeout.co.il/">#יום_השביתה</a>
        </div>
        <div className="share">
